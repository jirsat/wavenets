...
class MixtureLogisticLoss():
  ...
  """
  def __init__(self, bits = 8, name: str = 'MixtureLoss', **kwargs):
...
class MixtureNormalLoss():
  """Mixture loss function for PlusFastWaveNet.
  It computes negative log likelihood of the target given the mixture
  of normal distributions defined by the weights, means and log_scales.
  """
  def __init__(self, bits = 8 , name: str = 'MixtureNormalLoss', **kwargs):
    """Initialize MixtureLoss.
